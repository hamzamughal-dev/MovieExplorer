...
function Login() {
    ...
    if (isLoading) {
        return <Loader text="Logging in..." className="min-h-screen bg-[#202731]" />;
    }
    ...
    hover:shadow-lg">
                ...
                <form className="flex flex-col gap-4 " onSubmit={handleLogin}>
                    ...
                    <button type="submit" className="w-full py-3 rounded-[10px] bg-gradient-to-r from-[#01b4e4] to-[#90cea1] text-slate-900 text-base font-bold cursor-pointer transition-all duration-300 hover:-translate-y-0.5 hover:shadow-[0_12px_24px_rgba(1,180,228,0.5)] hover:scale-[1.02] active:translate-y-0">Login</button>
                </form>
            </div>
