        ...
        <div className="flex flex-col justify-end">
          ...
          <div className="flex flex-wrap gap-4 mb-6">
            ...
            <button
              ...
              className={`flex items-center gap-2 px-6 py-3 rounded-[12px] border font-semibold transition-all duration-200 cursor-pointer active:scale-[0.96] hover:scale-[1.02] disabled:opacity-75 disabled:cursor-not-allowed ${isFavorite
